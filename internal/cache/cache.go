...
func New(sizeInBytes int64) (*Cache, error) {
	...
	c.cache, err = ristretto.NewCache(&ristretto.Config{
		...
		Cost:        func(input any) int64 { return int64(size.Of(input)) }, // Use the size of the data as the cost.
	})
	if err != nil {
		return nil, err
	}
...
func (c *Cache) Get(namespace, key string) (value any, found bool) {
...
func (c *Cache) SetWithTTL(namespace, key string, value any, ttl time.Duration) {
	cost := int64(0) // Use zero to have it automatically compute the cost.
