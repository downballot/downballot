...
func (c *Client) Do(ctx context.Context, method string, path string, requestPayload any, responsePayload any) error {
	var envelope Envelope
	err := c.client.Do(ctx, method, path, requestPayload, &envelope)
	if err != nil {
